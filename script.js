...
console.log(SCHOOL)
// SCHOOL = "OtherCollege"
// i got an error cuz i am not supposed to change the type of a constant
...
console.log(2 + "3");
console.log(2 + 3);
//The first two are concatenate because if one is a string js converts the other to a string and joins them.
...
// console.log(b);
// the b variables will not be reached from outside of the block so that is
// why I have commened it because i dont want to ge any error in the terminal
